...
public class ProjectADriver {
	...
	public static void main(String[] args) {
		...
		if(testingExtraCredit) {
			/* IMPORTANT: TO TEST THE EXTRA CREDIT:
			 * a) Set the testingExtraCredit variable to true
		...
		/* TESTING PART TWO */	
			...
			if(!testingExtraCredit && list.size()==5) {
				System.err.println("Error! You must un-comment the three hard-coded lines in your constructor that filled up your list. \nPart Two will use your own add methods to fill the list.");
				System.err.println("Driver ending.");	System.exit(1);
			}
		...
		if(allTestsPassed) {
			...
			} else { // testingExtraCredit || testingPartTwo
				System.out.println("----------Summary---------- \nAll automated tests in Part Two have passed.");
				System.out.println("Be sure to manually look at the output to check the contents of the list.");
