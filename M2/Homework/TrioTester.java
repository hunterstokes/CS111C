...
public class TrioTester {
	...
	public static void main(String[] args) {
		...
		// UN-COMMENT WHEN YOU HAVE UPDATED THE CLASS HEADER TO ADD GENERICS AND WRITTEN BOTH CONSTRUCTORS
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR TOSTRING METHOD
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR GETTERS AND SETTERS
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR REPLACEALL
		// IMPORTANT NOTE: YOU ALSO NEED TO UN-COMMENT THE TESTER METHOD FOR THIS TO RUN
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR HASDUPLICATES METHOD
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR COUNT METHOD
		// IMPORTANT NOTE: YOU ALSO NEED TO UN-COMMENT THE TESTER METHOD FOR THIS TO RUN
		...
		// UN-COMMENT WHEN YOU HAVE WRITTEN YOUR EQUALS METHOD
		// IMPORTANT NOTE: YOU ALSO NEED TO UN-COMMENT TWO TESTER METHODS FOR THIS TO RUN
